...
public class IzracunajHesGUI extends javax.swing.JFrame {

    File file = null;
    int bufferSize = 8192;
    
    public IzracunajHesGUI() {
        initComponents();
        setDragAndDrop();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(IzracunajHesGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        
        java.awt.EventQueue.invokeLater(() -> {
            new IzracunajHesGUI().setVisible(true);
        });
    }
